...
class App_KernelProductionDebugContainer extends Container
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost6727dc0', static fn () => \EntityManagerGhost6727dc0::createLazyGhost(static fn ($proxy) => self::getDoctrine_Orm_DefaultEntityManagerService($container, $proxy)));
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['argument_resolver.request_payload'] = $container->createProxy('RequestPayloadValueResolverGhost4abed0a', static fn () => \RequestPayloadValueResolverGhost4abed0a::createLazyGhost(static fn ($proxy) => self::getArgumentResolver_RequestPayloadService($container, $proxy)));
        }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'redis_host' => $container->getEnv('key:host:url:REDIS_URL'),
            'redis_port' => $container->getEnv('key:port:url:REDIS_URL'),
