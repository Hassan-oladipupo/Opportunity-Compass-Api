 ...
 */
class getSecurity_Authenticator_AccessToken_MainService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authenticator.access_token.main'] = new \Symfony\Component\Security\Http\Authenticator\AccessTokenAuthenticator(new \App\Security\AccessTokenHandler(($container->privates['Redis'] ?? $container->load('getRedisService'))), new \Symfony\Component\Security\Http\AccessToken\HeaderAccessTokenExtractor(), ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService')), NULL, NULL, NULL);
    }
}
