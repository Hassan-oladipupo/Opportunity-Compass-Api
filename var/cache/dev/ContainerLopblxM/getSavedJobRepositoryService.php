 ...
 */
class getSavedJobRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SavedJobRepository' shared autowired service.
     *
     * @return \App\Repository\SavedJobRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SavedJobRepository.php';

        return $container->privates['App\\Repository\\SavedJobRepository'] = new \App\Repository\SavedJobRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
