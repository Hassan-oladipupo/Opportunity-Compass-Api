 ...
 */
class getApplicationFormRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ApplicationFormRepository' shared autowired service.
     *
     * @return \App\Repository\ApplicationFormRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApplicationFormRepository.php';

        return $container->privates['App\\Repository\\ApplicationFormRepository'] = new \App\Repository\ApplicationFormRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
